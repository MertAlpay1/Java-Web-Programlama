...
public class YoneticiDoktorUzmanlikAlanGuncelleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String yeniUzmanlikAlan = request.getParameter("uzmanlıkAlan");
            String doktorID = YoneticiDoktorSecServlet.getDoktor();

            String sql = "UPDATE doktor SET uzmanlık_alan=? WHERE doktor_id=?";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, yeniUzmanlikAlan);
            ...
            if (rowCount > 0) {
                ...
                out.println("<p>Doktor uzmanlık alanı başarıyla güncellendi.</p>");
