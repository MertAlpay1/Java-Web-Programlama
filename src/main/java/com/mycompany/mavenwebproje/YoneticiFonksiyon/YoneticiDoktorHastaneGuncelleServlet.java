...
public class YoneticiDoktorHastaneGuncelleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String yeniHastane = request.getParameter("Hastane");
            String doktorID = YoneticiDoktorSecServlet.getDoktor();

            String sql = "UPDATE doktor SET calıstıgı_hastane=? WHERE doktor_id=?";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, yeniHastane);
            ...
            if (rowCount > 0) {
                ...
                out.println("<p>Doktorun çalıştığı hastane başarıyla güncellendi.</p>");
