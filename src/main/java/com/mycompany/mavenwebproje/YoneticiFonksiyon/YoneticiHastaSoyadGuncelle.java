...
public class YoneticiHastaSoyadGuncelle extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "UPDATE hasta SET soyad=? WHERE hasta_id=?";
            ...
            if (rowCount > 0) {
                ...
                out.println("<p>Hasta soyadı başarıyla güncellendi.</p>");
