...
public class DoktorRandevularServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT r.randevu_id, r.randevu_tarih, r.randevu_saat,r.hasta_id, h.ad, h.soyad,h.cinsiyet,h.dogum_tarih, a.adres, t.telefon_no " +
                         "FROM randevu r " +
            ...
            pstmt.setString(1, DoktorGirisServlet.getLoggedInDocID());
            ...
            out.println("<th>Hasta Dogum Tarihi</th>");
            ...
            if (sayfa > 1) {
                out.println("<a href=\"DoktorRandevularServlet?sayfa=" + (sayfa - 1) + "\">Önceki Sayfa</a>");
            }
            if(tamSayfa==sayfaBoyutu){
            out.println("<a href=\"DoktorRandevularServlet?sayfa=" + (sayfa + 1) + "\">Sonraki Sayfa</a>");
            }
