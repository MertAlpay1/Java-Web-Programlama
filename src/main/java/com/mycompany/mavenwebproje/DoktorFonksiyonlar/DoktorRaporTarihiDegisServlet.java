...
public class DoktorRaporTarihiDegisServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String raporID = DoktorTibbiRaporGuncelleServlet.getSelectedRaporID();
        ...
        try {
            ...
            if (rs.next()) {
                ...
                TibbiRapor tibbiRapor = new TibbiRapor(yeniTarih, icerik, url, hastaID);
                Gson gson = new Gson();
                ...
                pstmt.setString(2, "Bir tıbbi rapor tarihi değiştirildi ");
                pstmt.executeUpdate();
                
                    out.println("<h2>Rapor tarihi başarıyla güncellendi!</h2>");
                    out.println("<a href=\"DoktorRaporGuncelle.html\">Geri Dön</a>");
                } else {
