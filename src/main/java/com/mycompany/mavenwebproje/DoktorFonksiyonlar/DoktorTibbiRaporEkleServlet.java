...
@MultipartConfig
public class DoktorTibbiRaporEkleServlet extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        TibbiRapor tibbiRapor = new TibbiRapor(raporTarihi, raporIcerigi, raporDosyaURL, DoktorTibbiRaporEkle.getHasta());
        Gson gson = new Gson();
        ...
        String hastaID = DoktorTibbiRaporEkle.getHasta();
