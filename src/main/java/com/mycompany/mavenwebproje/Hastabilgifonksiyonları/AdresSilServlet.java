...
public class AdresSilServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rowCount > 0) {
                ...
                out.println("<p>Kullanıcının tüm adresleri başarıyla silindi.</p>");
                out.println("<a href=\"YHGuncelleme.html\">Geri Dön</a>");
                out.println("</body>");
                out.println("</html>");
            } else {
                out.println("Kullanıcın Mevcut Adresi Bulunmamaktadır.");
                out.println("<a href=\"YHGuncelleme.html\">Geri Dön</a>");
            }
